...
summary: Una guía completa de Ode — qué es, cómo funciona, cómo escribir y gestionar entradas, y cómo desplegarlo en Cloudflare Pages, Railway o GitHub Pages.
lang: es
...
2. Nuevo proyecto → **Direct Upload**
3. Arrastra la carpeta `out/` al área de carga

**Opción B — Integración con Git:**
...
:::tip
El plan gratuito de Cloudflare Pages incluye 500 compilaciones al mes y ancho de banda ilimitado. Para un blog personal es efectivamente ilimitado.
:::
